...
export class FaqsComponent {
  ...
  readonly faqs: Faq[] = [
    ...
    },
    {
      ...
      a: 'Orders can be cancelled within 1 hour of placement by contacting us at hello@tedclothing.in. Once an order is packed or dispatched it cannot be cancelled — you may initiate a return after delivery.',
    },
  ];
